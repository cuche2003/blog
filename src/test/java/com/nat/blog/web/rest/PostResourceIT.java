...
import static com.nat.blog.web.rest.TestUtil.createUpdateProxyForBean;
...
class PostResourceIT {
    ...
    public static Post createEntity(EntityManager em) {
        Post post = new Post().title(DEFAULT_TITLE).content(DEFAULT_CONTENT);
        // Add required entity
    ...
    public static Post createUpdatedEntity(EntityManager em) {
        Post updatedPost = new Post().title(UPDATED_TITLE).content(UPDATED_CONTENT);
        // Add required entity
        User user = UserResourceIT.createEntity();
        em.persist(user);
        em.flush();
